...
const selectIcon =
  "dark:bg-zinc-600 outline outline-1 hover:outline-2 outline-zinc-500 dark:text-white text-zinc-800 font-semibold p-1 rounded whitespace-nowrap ml-5 flex items-center justify-center";
