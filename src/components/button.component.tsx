...
const selectIcon =
  "dark:bg-zinc-600 bg-white outline outline-1 focus:outline-2 outline-zinc-500 dark:text-white text-zinc-800 font-semibold p-[5px] ml-5 rounded whitespace-nowrap flex items-center justify-center";
const selectColor =
