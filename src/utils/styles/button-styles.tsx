...
export const buttonClasses = {
  ...
  addHabitButton:
    "bg-blue-500 drop-shadow-[0px_5px_0px_rgba(52,115,217,1)] hover:drop-shadow-none hover:translate-y-[5px] transition-all duration-[50] hover:bg-blue-600 min-w-[150px] text-white font-semibold py-2 mt-3 px-4 rounded whitespace-nowrap",
  selectIcon:
